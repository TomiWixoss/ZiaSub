export default {
  ...
  onboarding: {
    ...
    storage: {
      ...
      subtitle:
        "Choose a folder to save backup data. You can restore data from here when reinstalling the app.",
      subtitleBackup:
        "Choose a folder for backup. If there's an existing backup, you can restore it now.",
      noPath: "No folder selected",
      checking: "Checking...",
      backupFound: "Backup found",
      backupDetail:
        "{{chats}} chats, {{translations}} translations (created {{date}})",
      noBackup: "No backup in this folder",
      useDefault: "Use default folder",
      pickFolder: "Choose another folder",
      existingDataTitle: "Backup Found",
      existingDataMessage:
        "This folder has a backup with {{chats}} chats and {{translations}} translations. Do you want to restore?",
      restore: "Restore",
      skipRestore: "Skip",
      clearAndNew: "Clear and start fresh",
      errorSetup: "Cannot setup backup folder",
  ...
  settings: {
    ...
    data: {
      title: "Data",
      description: "Manage data and backup",
      ...
      backupNowDesc: "Save data to backup file",
      backupSuccess: "Backup completed successfully",
      backupError: "Cannot create backup",
      restore: "Restore",
      restoreDesc: "Restore data from backup file",
      restoreTitle: "Restore Data",
      restoreMessage:
        "Current data will be overwritten. Are you sure you want to restore?",
      restoreConfirm: "Restore",
      restoreSuccess: "Restored successfully. App will restart.",
      restoreError: "Cannot restore",
      autoBackup: "Auto backup",
      autoBackupOn: "Backup when exiting app",
      autoBackupOff: "Disabled",
      pathChanged: "Backup folder changed",
      pathChangeError: "Cannot change folder",
      // Danger zone
      ...
      resetApp: "Reset app",
      resetAppDesc: "Clear data and return to onboarding screen",
      resetTitle: "Reset App",
      resetMessage:
        "All data will be deleted and you will need to set up again from scratch.",
      resetConfirm: "Reset",
