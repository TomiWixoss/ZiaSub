...
export const INJECTED_JAVASCRIPT_DESKTOP = `
  (function() {
    ...
    function updateSubtitleStyle() {
      ...
      subtitleLayer.style.cssText = 'position:absolute;bottom:' + bottomPos + 'px;left:5%;right:5%;max-width:90%;margin:0 auto;text-align:center;color:#FFF;font-size:' + subtitleFontSize + 'px;font-weight:' + weight + ';font-style:' + subtitleFontStyle + ';font-family:system-ui,sans-serif;' + textStroke + textShadow + 'background:rgba(0,0,0,0.7);padding:8px 16px;border-radius:8px;pointer-events:none;z-index:2147483647;display:' + (lastSubtitle ? 'block' : 'none') + ';line-height:1.5;white-space:pre-line;';
    }
...
// Mobile YouTube injected script
